        ...
        <View style={styles.container}>
          ...
          <View style={styles.bottomContainer}>
            ...
            >
                ...
                <View style={[styles.row, styles.padding]}> 
                    <View> <Text> Destinatário: </Text> </View>
                ...
                <View style={[styles.row, styles.padding]}> 
                    <View> <Text> Horário Coleta: </Text> </View>
                    <View> <Text>  XXX </Text> </View> 
                </View>
                <View style={styles.padding}> <Text> Temperatura da Coleta: {"XXX"} </Text> </View>
                <View style={styles.titleWrapper}>
                    <Title text={"Adicionar Evidência:"} />
                </View>
                <View> <ImageInput  /> </View> 
